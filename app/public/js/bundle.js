...
var _highstock = __webpack_require__(121);
...
var _stocks = __webpack_require__(125);

var _stocks2 = _interopRequireDefault(_stocks);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_jquery2.default.getJSON('http://' + "localhost" + ':' + "7001" + '/api/values', function (data) {
    var series = data.reduce(function (acc, datum) {
        acc.value.push([+(0, _moment2.default)(datum.created_at), datum.value]);

        acc.deposit.push([+(0, _moment2.default)(datum.created_at), datum.deposit_total]);
    ...
    // Create the chart
    var chart = _highstock2.default.stockChart('chart', {
        chart: {
            height: 400
        },
        ...
        tooltip: {
            ...
            formatter: function formatter() {
                ...
                var percentage = this.points[0].y / this.points[1].y - 1;
    ...
    (0, _jquery2.default)('#small').click(function () {
        chart.setSize(400);
    });

    (0, _jquery2.default)('#large').click(function () {
        chart.setSize(800);
    });

    (0, _jquery2.default)('#auto').click(function () {
        chart.setSize(null);
    });
});
...
module.exports = [[1501545600000,150.05],[1501632000000,157.14],[1501718400000,155.57],[1501804800000,156.39],[1502064000000,158.81],[1502150400000,160.08],[1502236800000,161.06],[1502323200000,155.32],[1502409600000,157.48],[1502668800000,159.85],[1502755200000,161.6],[1502841600000,160.95],[1502928000000,157.86],[1503014400000,157.5],[1503273600000,157.21],[1503360000000,159.78],[1503446400000,159.98]]
